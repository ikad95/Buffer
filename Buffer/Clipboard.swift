...
class Clipboard {
  ...
  func copy(_ item: HistoryItem?, removeFormatting: Bool = false) {
    ...
    pasteboard.setString("", forType: .fromBuffer)
  ...
  func paste() {
    ...
    // See https://github.com/p0deje/Buffer/issues/482 for details.
  ...
  func checkForChangesInPasteboard() {
    ...
    // See https://github.com/p0deje/Buffer/issues/241.
    ...
    // - https://github.com/p0deje/Buffer/issues/78
    // - https://github.com/p0deje/Buffer/issues/472
    ...
    pasteboard.pasteboardItems?.forEach({ item in
      ...
      // https://github.com/p0deje/Buffer/issues/613
      // https://github.com/p0deje/Buffer/issues/770
  ...
  // - Chrome Remote Desktop (https://github.com/p0deje/Buffer/issues/948)
  // - Netbeans (https://github.com/p0deje/Buffer/issues/879)
  private func sync() {
  ...
  private func clearFormatting(_ contents: [HistoryItemContent]) -> [HistoryItemContent] {
    ...
    if !stringContents.isEmpty {
      ...
      // Preserve file URLs.
      // https://github.com/p0deje/Buffer/issues/962
