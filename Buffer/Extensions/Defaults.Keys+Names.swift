...
extension Defaults.Keys {
  ...
  static let menuIcon = Key<MenuIcon>("menuIcon", default: .buffer)
  ...
  static let enableLRU = Key<Bool>("enableLRU", default: true)
  static let lruKeepDays = Key<Int>("lruKeepDays", default: 7)
  ...
  static let theme = Key<Theme>("theme", default: .default)
}
