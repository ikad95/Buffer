...
extension NSPasteboard.PasteboardType: Defaults.Serializable {
  ...
  // https://github.com/p0deje/Buffer/issues/429#issuecomment-1182575226
  static let modified = NSPasteboard.PasteboardType(rawValue: "x.nspasteboard.ModifiedType")

  // Marks that copy was made from Buffer.
  static let fromBuffer = NSPasteboard.PasteboardType(rawValue: "org.codexvault.Buffer")
